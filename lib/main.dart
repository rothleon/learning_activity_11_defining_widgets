            ...
            child: Row(
              children: <Widget>[
                SizedBox(
                  ...
                  child: Stack(
                    ...
                    children: <Widget>[
                      ...
                      Center(
                        child: Text(dailyForecast.getDate(currentDate.day).toString(), style: textTheme.displayMedium, ),
                      ),
                    ],
                  ),
                ),
                Expanded(
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Text(dailyForecast.getWeekday(currentDate.weekday), style: textTheme.headlineMedium, ),
                ...
                Padding(
                  ...
                  child: Text('${dailyForecast.highTemp} | ${dailyForecast.lowTemp} F', style: textTheme.titleMedium, ),
                ),
              ],
            ),
          );
